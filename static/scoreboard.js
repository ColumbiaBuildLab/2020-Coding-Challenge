...
function increase_score(id){
  ...
  $.ajax({
    ...
    success: function(result){
      // CODE: Checks that result is not undefined and updates the scoreboard only if result contains the scoreboard array.
      if(result?.scoreboard) display_scoreboard(result.scoreboard)
    },
