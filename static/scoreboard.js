function display_scoreboard(scoreboard) {
  $("#teams").empty();
  //#two ways to sort: we can also sort it here
  //prob better to do it this way than in the increase_score()
  //function in server.py so that in the beginning
  //even if the scoreboard in server.py isn't initialized
  //in the order of decreasing score, we still automatically
  //sort it in the very first rendering of the page
